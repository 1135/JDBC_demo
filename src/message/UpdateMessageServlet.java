 ...
 */
public class UpdateMessageServlet  extends javax.servlet.http.HttpServlet implements javax.servlet.Servlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            PreparedStatement pstm = con.prepareStatement("UPDATE student SET name =? , area =? ,message=? where id=?");
            pstm.setString(4, s1);
            pstm.setString(1, s2);
            pstm.setString(2, s3);
            if (s4.length() == 0) pstm.setString(4, null);
            else pstm.setString(3, s4);
